import "./Main.css";
import Father from "../../images/tired-father-reading-book-his-son-parenting-stress-vector-illustration-white-background_223337-6325 1.png";
import LittleBoy from "../../images/little-boy-playing-construction-toy-isolated-white-background-vector-illustration-kid-building-pyramid-blocks-188212129 1.png";
function Main() {
  return (
    <>
